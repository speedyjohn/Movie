...
public class UserPasswordValidator(
    ...
    IDirectoryService directoryService = null) : IUserPasswordValidator
{
    ...
    protected readonly ISqlConnections sqlConnections =
        sqlConnections ?? throw new ArgumentNullException(nameof(sqlConnections));

    protected readonly IUserRetrieveService userRetriever =
    ...
    private PasswordValidationResult ValidateExistingUser(ref string username, string password, UserDefinition user)
    {
        ...
        var throttler = new Throttler(cache.Memory, "ValidateUser:" + username.ToLowerInvariant(),
