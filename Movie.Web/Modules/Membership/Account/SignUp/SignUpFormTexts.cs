...
public static class SignUpFormTexts
{
    ...
    public static readonly LocalText ActivationCompleteMessage =
        "Your account is now activated. Use the email and password you used while signing up to login.";
    ...
    public static readonly LocalText Success =
        "An email with instructions to activate your account has been sent to your email address. Please check your emails.";
}